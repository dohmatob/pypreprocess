...
descr = """fMRI preprocessing in pure Python"""
...
DESCRIPTION = 'fMRI preprocessing in pure Python'
LONG_DESCRIPTION = open('README.rst').read()
MAINTAINER = 'DOHMATOB Elvis Dopgima'
MAINTAINER_EMAIL = 'elvis.dohmatob@inria.fr'
URL = 'http://github.com/pypreprocess'
LICENSE = 'new BSD'
DOWNLOAD_URL = 'http://github.com/pypreprocess'
VERSION = '0.1-git'
...
def configuration(parent_package='', top_path=None):
    ...
    config.add_subpackage('pypreprocess/base')
    config.add_subpackage('pypreprocess/algorithms')
