...
import pypreprocess.base.io.utils as utils
...
def generate_normalization_thumbnails(
    ...
    if isinstance(normalized_files, basestring):
        ...
        mean_normalized_img = utils.compute_mean_3D_image(normalized_files)
...
def generate_segmentation_thumbnails(
    ...
    if isinstance(normalized_files, basestring):
        ...
        utils.compute_mean_3D_image(normalized_files,
